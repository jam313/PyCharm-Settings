...
def sigtimedwait(sigset, (timeout_sec, timeout_nsec)): # real signature unknown; restored from __doc__
    """
...
def sigwaitinfo(sigset): # real signature unknown; restored from __doc__
    """
